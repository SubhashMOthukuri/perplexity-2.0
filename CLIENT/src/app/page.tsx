...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (currentMessage.trim()) {
      ...
      try {
        ...
        let url = `https://perplexity-latest-11u2.onrender.com/chat_stream/${encodeURIComponent(userInput)}`;
        if (checkpointId) {
  ...
  return (
    <div className="flex justify-center bg-gray-50 min-h-screen py-8 px-6">
      <div className="w-[75%] bg-white flex flex-col rounded-3xl shadow-lg border border-gray-200 overflow-hidden h-[90vh]">
        <Header />
